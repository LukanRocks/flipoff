...
const NO_CACHE_PATHS = new Set(['/', '/index.html', '/display.html', '/admin', '/admin/', '/screenshot.png', '/favicon.ico'])
 ...
 * assets under /assets are exempt -- their names change when their contents
 * do, so they are safe to cache.
 */
