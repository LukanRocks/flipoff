...
function initChannel() {
  if (typeof BroadcastChannel === 'undefined') {
    document.querySelector('.ctrl-body').innerHTML = '<p class="no-support">Your browser does not support cross-tab control.<br>Try Chrome, Firefox, or Edge.</p>'
    return
  }
